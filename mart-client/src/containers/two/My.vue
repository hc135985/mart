<template>
    <div class="my">
       <div class="header">
       <span class="userinfo" @click="$router.history.push(`/setuserinfo/${uid}`)">完善个人资料</span>
        <span>
           {{userInfo.nickname}}
        </span> 
         <van-image
       ...
       <div class="main">
          <div class="order">
          <span
           @click="$router.push('/order/obligation')"
          >
          <van-icon name="coupon-o" />
          待付款<b v-show="obligation">{{obligation}}</b>
          </span>
          <span 
           @click="$router.push('/order/totakedelivery')"
          >
          ...
          <span
           @click="$router.push('/order/refund')"
          >
